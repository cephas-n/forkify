...
class RecipeView extends View {
    ...
    _generateMarkup () {
        return `<figure class="recipe__fig">
                ...
                <div class="recipe__details">
                    ...
                    <button class="btn--round btn--bookmark-recipe">
                        <svg class="">
                ...
                ${this._data.ingredients?.map((ingredient) => 
                    ...
                    <div class="recipe__quantity">${Number.isFinite(ingredient.quantity) ? new Fraction(ingredient.quantity).toString(): ''}</div>
    ...
    addHandlerUpdateServings (handler) { //pusblisher-subscriber patern:publisher
    ...
    addHandlerBookmarkRecipe (handler) {
        this._parentElement.addEventListener('click', function (e) {
            const btn = e.target.closest('.btn--bookmark-recipe');
